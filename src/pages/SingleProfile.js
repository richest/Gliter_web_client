...
import useToggle, { detectMob, restrictBack } from '../components/CommonFunction';
import moment from 'moment'
import { addDefaultSrc, checkLoginRole, fetchPreviousPage, returnDefaultImage, useForceUpdate } from "../commonFunctions";
...
const SingleProfile = (props) => {
  ...
  console.log(galleryImages, "wdkwkejf")
  return (
    <section className="home-wrapper">
            ...
            <div className="col-md-7 pl-5">
              <div className="profile-bio-inner my-3">
                <div className="chat-call-opt d-flex">
                  ...
                  <a className="bg-grd-clr mr-3" id="handlevideo" href="javascript:void(0)" onClick={() => handleVideoCall()}>
                    <i className="fas fa-video" />
                  </a>
                  <a className="bg-grd-clr" href="javascript:void(0)" onClick={showAllGift} >
      ...
      <Modal id="large-gallery-modal" show={openLargeModel} onHide={() => setOpenLargeModel(false)} backdrop="static" keyboard={false}>
        <div className="">

          <Carousel emulateTouch={true} useKeyboardArrows={true} selectedItem={galerryActiveIndex} showIndicators={false} swipeable={true} showStatus={false} showThumbs={false} autoPlay={false} >
        ...
        <a href="javascript:void(0)" className="modal-close" onClick={() => { setOpenLargeModel(false) }}><img src="/assets/images/btn_close.png" /></a>
      </Modal>
