...
import { addDefaultSrc, checkLiveDomain, removeVideoListRightClick, returnDefaultImage } from "../commonFunctions";
...
import useToggle, { restrictBack } from "../components/CommonFunction";
...
const LiveVideoChat = () => {
    ...
    const [spinWheel, changeWheel] = useState(0);

    const [streamerDetails, changeStreamerDetails] = useState(null);
    ...
    const [endVideoModel , setEndVideoModel] = useState(false)
    ...
    //   }
        ...
        if (!params.channel_name) {
            ...
            console.log(localStorage.getItem("videoCallPageRefresh"), "dkjfghfkjh")
        ...
        //    // fetch the client and streamer w.r.t channel name.... after 5 sec
          ...
          connectedPeopleInterval = window.setInterval(() => {
            ...
            SOCKET.emit("do_i_have_turn_on_wheel", { user_id: Number(videoCallParams.user_id), socket_id: localStorage.getItem("socket_id") })
            ...
            SOCKET.off("do_i_have_turn_on_wheel").on('do_i_have_turn_on_wheel', (data) => {
                ...
                changeStreamerDetails({name: data.name, image: data.image})
              })
                    ...
                    if (!!message.message.message) {
                        ...
                        if (message.message.chat_type === 4) {
                            ...
                            if (userData.user_id == message.sender_id) {
                                toast.dark(message.stripMessage, {
    ...
    const stopTheSpinner = async (luck) => {
        ...
        if (status_code == 200 && error == false) {
            const stripMessage = "("+userData.first_name + " " +userData.last_name + ") - " +  luck.desc;
    ...
    return (
        <section className="home-wrapper">
            ...
            <div className="header-bar" style={{ zIndex: 99999 }}>
                {
                    (!!userData && (userData.user_id != params.user_id) && playWheel && spinWheel) ?
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="vc-head-title d-flex flex-wrap align-items-center ml-5">
                                    <div className="vc-user-name d-flex flex-wrap align-items-center">
                                        <figure>
                                            <img onError={(e) => addDefaultSrc(e)} src={!!streamerDetails ? (changeImageLinkDomain() + streamerDetails.image) : returnDefaultImage()} alt="Augusta Castro" />
                                        </figure>
                                        {
                                            !!user &&
                                            <div className="name ml-2">
                                                {!!streamerDetails && streamerDetails.name}
                                                ...
                                                <span className="d-block small">{totalTimeLeft}</span>
                                                {
                                                    ...
                                                    <span className="small">
                                                        <img src="/assets/images/eye-icon.svg" /> {totalViews.length}</span>
                                                }
                        ...
                        <div className="col-lg-7 p-3">
                            <div className="video-live tab-top d-flex flex-wrap-wrap align-items-center">
                                <div className="vc-action-tab ml-auto mr-4 position-relative">
                                    ...
                                    <ul className="action-menu block-user-dropdown" id="actionBtn">
                                        ...
                                        {/* <li>
                                            {
                                                ...
                                                <a href="javascript:void(0)" onClick={() => setEndVideoModel(true)}>End Video</a>
                                            }
                                        </li> */}
                                    </ul>
                                    {
                                                (showEndVideo || (!!userData && userData.user_id != params.user_id)) &&
                                    <a href="javascript:void(0)" className="end-calls btn bg-grd-clr" onClick={() => setEndVideoModel(true)}>End Video</a>
                                    }
                                    </div>
                                <NavLinks />
                ...
                <div className="vc-screen d-flex h-100">
                    ...
                    <div class="col-md-3 live__comments_bg p-4">
                        <div class="live__comments__wrap">
                            <form onSubmit={CheckTextInputIsEmptyOrNot} autoComplete="off">
                                {
            ...
            <Modal className="coin-gained-modal" show={showGainedCoins} onHide={() => setShowGainedCoin(false)} backdrop="static" keyboard={false}>
                <div className="edit-profile-modal__inner">
                    <h4 className="theme-txt text-center mb-4 ">Coins Earned: {totalCoinsLeft - myEntryCoins}</h4>
                ...
                <a href="javascript:void(0)" className="modal-close" onClick={() => setShowGainedCoin(false)}><img src="/assets/images/btn_close.png" /></a>
            </Modal>
 
            <Modal className="End-call-modal" show={endVideoModel} onHide={() => setEndVideoModel(false)} backdrop="static" keyboard={false}>
                <div className="edit-profile-modal__inner">
                    <h4 className="theme-txt text-center mb-4 ">WANT TO GET OUT OF THE LIVE STREAM?</h4>
                  
                </div>
                <button className="btn bg-grd-clr" style={{ cursor: "pointer" }} onClick={endCall}>End Video</button>
                <a href="javascript:void(0)" className="modal-close" onClick={() => setEndVideoModel(false)}><img src="/assets/images/btn_close.png" /></a>
            </Modal>
            ...
            <Modal className="blacklist-modal" show={showAudiences} onHide={() => setShowAudiences(false)} backdrop="static" keyboard={false}>
                ...
                <a href="javascript:void(0)" className="modal-close" onClick={() => setShowAudiences(false)}><img src="/assets/images/btn_close.png" /></a>
            ...
            <Modal className="report-modal" show={showReport.model} onHide={closeReport} backdrop="static" keyboard={false}>
                ...
                <a href="javascript:void(0)" className="modal-close" onClick={closeReport}><img src="/assets/images/btn_close.png" /></a>
            </Modal>
        </section>
    )
}
