...
import { audioCall, randomMessageMe, selectUser, userProfile, videoCall } from '../features/userSlice';
...
import { addDefaultSrc, fetchPreviousPage, returnDefaultImage } from '../commonFunctions';
...
const Home = (props) => {
  ...
  userData = useSelector(userProfile).user.profile;
  ...
  //   console.log(direction, userId, "abccccccccccccccccccccccccccccc");
  //   if (direction == "left") {
  //     const bodyParameters = {
  //       session_id: localStorage.getItem("session_id"),
  //       user_id: userId,
            ...
            <div className="col-lg-3 option-bar p-3 vh-100 position-fixed">
              <div className="logo-tab mb-5 d-flex justify-content-between align-items-start">
                ...
                <div class="live-icon-top" onClick={handleChat}>
                  <img src="/assets/images/live.png" alt="Live" style={{ cursor: "pointer" }} />
                </div>
              ...
              <div className="filter-tab">
                ...
                <form action="#" method="post" className="form" >
                  ...
                  <div className="btns-group d-flex justify-content-between flex-wrap my-5">
                    {path == "/" ? <> <button className="btn bg-grd-clr" id="done-filter" type="submit" disabled onClick={filterHandle}>Done</button>
