...
import { addDefaultSrc, changeGiftLinkDomain, changeImageLinkDomain, checkLiveDomain, checkLoginRole, removeVideoListRightClick, returnDefaultImage } from "../commonFunctions";
...
connectedPeopleInterval, updateConnectedPeopleTimeInterval, connectedPeopleIntervalBeforeAck,
          ...
          if (!!message.message.message) {
              ...
              if (message.message.chat_type === 1) {
                  if ((!!userData && !!videoCallParams && userData.user_id == videoCallParams.user_from_id)) {
                    ...
                    let show_host_coins = false;
                    if (localStorage.getItem("is_streamer_calling") == "true") {
                      show_host_coins = true;
                    }
                    // audience
                    liveVideoManageCoinsTimeViews(show_host_coins)
                  }
          ...
          <div className="row no-gutters">
            <div className="col-lg-5 p-3">
              <div className="d-flex align-items-center">
                ...
                <div className="vc-head-title d-flex align-items-center ml-5">
