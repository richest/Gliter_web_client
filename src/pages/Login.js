...
import { addBodyClass, detectMob, restrictBack } from '../components/CommonFunction';
...
const Login = () => {
      ...
      case 1:
        return (
          <div className="signup-inner" id="login-tab-1">
            ...
            <a target="_blank" href="https://play.google.com/store/apps/details?id=com.goldenposelatincorp.glittersclient">
                                <img src="/assets/images/playstore.png" style={{width: "60px", height: "45px"}} alt="play store" className="mr-2"/>
                                <div class="app-store__link">
                                    <p class="mb-0 text-white">Available On The<br/>Google play</p>
                                </div>
                            </a>
            </div>
  ...
  return (
    <section className="signup-wrapper">
      ...
      <div className="signup-page">
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            ...
            <div className="col-md-4 mx-auto">
              <form  id="login_form" onSubmit={handlePhoneSumbit} >
      ...
      <TermPolicy/>
        <a href="javascript:void(0)" className="modal-close" onClick={() => setTermPolicyModel(false)}><img src="assets/images/btn_close.png" /></a>
