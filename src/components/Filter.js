        ...
        <div className="btns-group d-flex justify-content-between flex-wrap my-5">
          {path == "/" ? <> <button className="btn bg-grd-clr" id="done-filter" type="submit" disabled onClick={filterHandle}>Done</button>
            ...
            : path == "/search-home" ? <> <button className="unknown-home btn bg-grd-clr" type="submit" onClick={filterHandle} disabled>Done</button>
              ...
              : <> <button className="unknown-home btn bg-grd-clr" type="submit" disabled onClick={filterHandle}>Done</button>
                <button className="unknown-home btn bg-grd-clr" type="reset" disabled onClick={handleReset}>Reset</button></>}
        </div>
      </form>
    </div>
